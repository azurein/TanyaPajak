...
class SimulateController extends Controller
{
	...
	public function publish(){
		...
		DB::insert("INSERT INTO tax_qa(parent_tax_qa_id,question,answer,priority,stsrc,edit_by,edit_at) SELECT parent_tax_qa_id,question,answer,priority,'A',".Session::get('user_id').",NOW() FROM temp_tax_qa WHERE stsrc <> 'D' ");
		...
		DB::insert("INSERT INTO tax_type(tax_type_name,tax_type_descr,percentage,is_shown,stsrc,edit_by,edit_at) SELECT tax_type_name,tax_type_descr,percentage,is_shown,'A',".Session::get('user_id').",NOW() FROM temp_tax_type WHERE stsrc <> 'D'");
